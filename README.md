...
App 内自带浏览器,自动嗅探视频、一键投屏,比网页版省事——**打开网站 → 登录播放 → 点「投屏到电视」**,不用弄书签、不用复制链接。地址栏下方内置了哔哩哔哩、芒果TV、优酷、腾讯视频、爱奇艺、西瓜视频、YouTube、爱壹帆、欧乐影院 等常用网站的快捷按钮,点一下直达,不用手打网址(Boox 上尤其省事)。
...
页面顶部有「常用视频网站」快捷入口(哔哩哔哩、芒果TV、优酷、腾讯视频、爱奇艺、西瓜视频、YouTube、爱壹帆、欧乐影院),点一下就在新标签页打开对应网站,省去手打网址;打开后再按下面两种方法之一投屏。
